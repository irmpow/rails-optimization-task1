...
def parse_data_from_file(file_name = DATA_FILE)
  ...
  [users, sessions, users_session, unique_browser.count]
end
...
def work(file_name = DATA_FILE)
  ...
  users, sessions, users_session, unique_browsers_count = parse_data_from_file file_name
...
#     when 'data16.txt'
#       current_test_results = 9
#     when 'data32.txt'
#       current_test_results = 25
#     when 'data64.txt'
#       current_test_results = 107
#     when 'data128.txt'
